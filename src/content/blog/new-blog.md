---
title: "Building My Own Web Presence"
...
![Dark Flowers](/images/blog/dark-flowers.jpg)
...
I wish I had stuck with my [first website](https://github.com/dcardamo/wwwindex) and evolved it over the years.  Its 25 years old (as I write this), I wrote it myself in Perl.  Its just the code to host the site, I wish I had the content still.
[My photo album](https://github.com/dcardamo/palbum) was written by myself too in the same year.  Also written in Perl.
...
Using it, I setup and customized my own [Astro.build](astro.build) site.  Its fairly minimal, lets me add in my own code (which Claude Code writes for me), and generates a static site.

I host this myself, and you can see [the code](https://github.com/dcardamo/www) for it.
